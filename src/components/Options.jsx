...
function Options({ darkMode }) {
  ...
  return (
    <div className="flex md:flex-row items-center justify-center gap-6 py-6 w-full max-w-[90vw] mx-auto min-h-screen">
      <ThemeToggle
        option1={option}
        selectedTopic1={selectedTopic}
        icon={CategoryIcon}
      />

      <div className="flex flex-col md:flex-row items-start justify-center gap-6 py-6 w-full">
        {/* Left Half (used) */}
